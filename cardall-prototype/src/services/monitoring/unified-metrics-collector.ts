...
class UnifiedMetricsCollector {
  ...
  private { optimize: () => {} }: RealtimePerformanceOptimizer | null = null
  ...
  private initializeSystemIntegration(): void {
    try {
      ...
      // 集成性能优化器
      if (typeof window !== 'undefined' && window.{ optimize: () => {} }) {
...
declare global {
  interface Window {
    ...
    { optimize: () => {} }?: RealtimePerformanceOptimizer
