...
export // 扩展的数据库文件夹实体
export // 扩展的数据库标签实体
export // 图片存储实体 - 统一图片管理
export   storageMode: 'indexeddb' | 'filesystem' | 'cloud'
  createdAt: Date
  updatedAt: Date
  syncVersion: number
  lastSyncAt?: Date
...
// 同步元数据表接口
export // 冲突记录表接口
export // 同步操作队列 - 统一同步逻辑
export interface { id: string; type: string; data: any } {
  id?: string
