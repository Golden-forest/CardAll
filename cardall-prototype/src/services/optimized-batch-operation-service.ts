...
import { db, type DbCard, type DbFolder, type DbTag, type DbImage, type { id: string; type: string; data: any } } from './database-unified'
...
export class OptimizedBatchOperationService {
  ...
  private async processCardUpdateBatch(
    ...
    const syncOperations: { id: string; type: string; data: any }[] = []
