/**
 * 使用Service Role Key创建存储桶
 * 需要从Supabase Dashboard获取service role key
 */
...
// 从环境变量或直接输入获取service role key
const serviceRoleKey = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVsd25wZWpsd2tnZGFjYXVndnZkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MzMzOTE1MCwiZXhwIjoyMDY4OTE1MTUwfQ.Ks4w_B1IuJHl2AC5JQz2XWvX6J8XJjRr_J2z7_7Y7Y'

if (!serviceRoleKey || serviceRoleKey === 'your-service-role-key-here') {
  console.log('❌ 错误: 需要提供有效的Service Role Key')
  console.log('请从Supabase Dashboard > Settings > API > Project API keys > service_role获取')
  process.exit(1)
}
...
async function createBucketsWithServiceRole() {
  console.log('🔑 使用Service Role Key创建存储桶...')
