...
export class MigrationValidator {
  ...
  private async validateDataIntegrity(sourceCards?: Card[]): Promise<ValidationSection> {
    ...
    try {
      ...
      section.errors.push(`Data integrity validation failed: ${error instanceof Error ? error.message : String(error)}`)
  ...
  private async validateFunctionality(): Promise<ValidationSection> {
    ...
    try {
      ...
      section.status = 'failed'
      section.errors.push(`Functionality validation failed: ${error instanceof Error ? error.message : String(error)}`)
  ...
  private async validateCRUDOperations(): Promise<ValidationCheck> {
    ...
    try {
      ...
      return {
        name: 'CRUD Operations',
        passed: false,
        details: `CRUD test failed: ${error instanceof Error ? error.message : String(error)}`,
        importance: 'critical'
      }
    }
  }
  ...
  private async validateTransactionSupport(): Promise<ValidationCheck> {
    try {
      ...
      return {
        name: 'Transaction Support',
        passed: false,
        details: `Transaction test failed: ${error instanceof Error ? error.message : String(error)}`,
        importance: 'medium'
      }
    }
  }
  ...
  private async validatePerformance(): Promise<ValidationSection> {
    ...
    try {
      ...
      section.status = 'failed'
      section.errors.push(`Performance validation failed: ${error instanceof Error ? error.message : String(error)}`)
    }
  ...
  private async validateReadPerformance(): Promise<ValidationCheck> {
    try {
      ...
      return {
        name: 'Read Performance',
        passed: false,
        details: `Read performance test failed: ${error instanceof Error ? error.message : String(error)}`,
        importance: 'medium'
      }
    }
  }
  ...
  private async validateWritePerformance(): Promise<ValidationCheck> {
    try {
      ...
      return {
        name: 'Write Performance',
        passed: false,
        details: `Write performance test failed: ${error instanceof Error ? error.message : String(error)}`,
        importance: 'medium'
      }
    }
  }
  ...
  private async validateQueryPerformance(): Promise<ValidationCheck> {
    try {
      ...
      return {
        name: 'Query Performance',
        passed: false,
        details: `Query performance test failed: ${error instanceof Error ? error.message : String(error)}`,
        importance: 'medium'
      }
    }
  }
  ...
  private async validateRollbackResult(backup: BackupResult): Promise<{ success: boolean; errors: string[]; warnings: string[] }> {
    ...
    try {
      ...
      return {
        success: false,
        errors: [error instanceof Error ? error.message : 'Rollback validation failed'],
        warnings: []
      }
    }
  }
  ...
  clearValidationCache(): void {
    try {
      ...
      console.warn('Failed to clear validation cache:', error)
    }
  }
}
