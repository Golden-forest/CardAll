...
export interface ErrorHandlingOptions {
  ...
  customHandlers?: Record<StorageErrorType, ErrorHandlingStrategy>
}
...
export interface ErrorHandler {
  ...
  handle(error: StorageError, context: ErrorContext): Promise<boolean>
...
export class UnifiedErrorHandler {
  ...
  async handleError(
    ...
    try {
      ...
      errorReport.handlingStrategy = ErrorHandlingStrategy.BLOCK_OPERATION
    }
