...
export interface ConsistencyCheckerConfig {
  ...
  strategy: {
    ...
    checkOnSync: boolean // 同步后自动检查
    checkOnNetworkChange: boolean // 网络变化后检查
  }
...
export class DataConsistencyChecker {
  ...
  private async initialize(): Promise<void> {
    try {
      ...
      console.error('Failed to initialize DataConsistencyChecker:', error)
      throw error
    }
  }
  ...
  async stop(): Promise<void> {
    ...
    try {
      ...
      console.error('Failed to stop DataConsistencyChecker:', error)
      throw error
    }
  }
    ...
    for (const entityType of entityTypes) {
      for (const checkType of checkTypes) {
        try {
          ...
          console.error(`Failed to perform ${checkType} check for ${entityType}:`, error)
  ...
  private async checkStructuralConsistency(
    ...
    try {
      ...
      return this.createErrorResult('structural', entityType, error, userId, startTime)
    }
  }
  ...
  private async checkReferentialConsistency(
    ...
    try {
      ...
      return this.createErrorResult('referential', entityType, error, userId, startTime)
    }
  }
  ...
  private async checkDataConsistency(
    ...
    try {
      ...
      return this.createErrorResult('data', entityType, error, userId, startTime)
    }
  }
  ...
  private async checkTimestampConsistency(
    ...
    try {
      ...
      return this.createErrorResult('timestamp', entityType, error, userId, startTime)
    }
  }
  ...
  private async checkVersionConsistency(
    ...
    try {
      ...
      return this.createErrorResult('version', entityType, error, userId, startTime)
    }
  }
  ...
  private async checkCountConsistency(
    ...
    try {
      ...
      return this.createErrorResult('count', entityType, error, userId, startTime)
    }
  }
  ...
  private async checkChecksumConsistency(
    ...
    try {
      ...
      return this.createErrorResult('checksum', entityType, error, userId, startTime)
    }
  }
  ...
  private async checkBusinessConsistency(
    ...
    try {
      ...
      return this.createErrorResult('business', entityType, error, userId, startTime)
    }
  }
  ...
  private async getRemoteData(
    ...
    try {
      ...
      console.warn(`Failed to fetch remote data for ${entityType}:`, error)
      return []
    }
  }
  ...
  private async autoFix(result: ConsistencyCheckResult): Promise<void> {
    ...
    try {
      ...
      console.error(`Auto-fix failed for ${result.id}:`, error)
    }
  }
